...
// membuat class AddKaryawanCoba memuat bundle untuk format semua source kode pada aplikasi.
class AddKaryawanCoba : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_add_karyawan_coba)
